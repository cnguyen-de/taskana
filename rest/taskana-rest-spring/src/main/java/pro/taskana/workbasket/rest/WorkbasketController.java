...
public class WorkbasketController extends AbstractPagingController {
  ...
  @GetMapping(path = RestEndpoints.URL_WORKBASKET_ID_ACCESSITEMS, produces = MediaTypes.HAL_JSON_VALUE)
  @Transactional(readOnly = true, rollbackFor = Exception.class)
  ...
  @PutMapping(path = RestEndpoints.URL_WORKBASKET_ID_ACCESSITEMS)
  @Transactional(rollbackFor = Exception.class)
  public ResponseEntity<TaskanaPagedModel<WorkbasketAccessItemRepresentationModel>>
  ...
  @GetMapping(path = RestEndpoints.URL_WORKBASKET_ID_DISTRIBUTION, produces = MediaTypes.HAL_JSON_VALUE)
  @Transactional(readOnly = true, rollbackFor = Exception.class)
