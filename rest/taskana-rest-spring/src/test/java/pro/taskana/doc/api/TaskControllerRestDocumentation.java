...
class TaskControllerRestDocumentation extends BaseRestDocumentation {
  ...
  void updateTaskDocTest() throws Exception {
    URL url =
        new URL(restHelper.toUrl(RestEndpoints.URL_TASKS_ID, "TKI:100000000000000000000000000000000000"));
  ...
  void createAndDeleteTaskDocTest() throws Exception {
    ...
    this.mockMvc
        .perform(
            RestDocumentationRequestBuilders.delete(restHelper.toUrl(RestEndpoints.URL_TASKS_ID, newId))
  ...
  void transferTaskDocTest() throws Exception {
    ...
    this.mockMvc
        .perform(
            RestDocumentationRequestBuilders.post(
                    restHelper.toUrl(
                        RestEndpoints.URL_TASKS_ID_TRANSFER_WORKBASKETID,
                        newId,
